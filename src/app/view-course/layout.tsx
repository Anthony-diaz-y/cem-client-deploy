...
export default function ViewCourseLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      ...
      {reviewModal && <VideoDetailsReviewModal setReviewModal={setReviewModal} />}
    </>
  )
}
