    ...
    return (
        <nav className={`z-[10] flex h-14 w-full items-center justify-center border-b-[1px] border-b-richblack-700 text-white translate-y-0 transition-all ${showNavbar} `}>
            ...
            <div className='flex w-11/12 max-w-maxContent items-center justify-between '>
                {/* logo */}
                <Link href="/">
                    <img src={getImageUrl(studyNotionLogo)} width={160} height={42} loading='lazy' alt="StudyNotion Logo" />
                </Link>
                                ...
                                token === null && (
                                    <Link href="/auth/login">
                                        ...
                                        <button className={` px-[12px] py-[8px] text-richblack-100 rounded-md 
                                         ${matchRoute('/auth/login') ? 'border-[2.5px] border-yellow-50' : 'border border-richblack-700 bg-richblack-800'} `}
                                        >
                                            Log in
                                        </button>
                                    </Link>
                            ...
                            }
                            {
                                token === null && (
                                    <Link href="/auth/signup">
                                        ...
                                        <button className={` px-[12px] py-[8px] text-richblack-100 rounded-md 
                                         ${matchRoute('/auth/signup') ? 'border-[2.5px] border-yellow-50' : 'border border-richblack-700 bg-richblack-800'} `}
                                        >
                                            Sign Up
                                        </button>
                                    </Link>
