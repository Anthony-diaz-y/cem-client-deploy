...
export const ExpertCard: React.FC<ExpertCardProps> = ({ expert }) => {
  return (
    <div className="rounded-xl p-7 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 flex flex-col items-center text-center justify-between w-full" style={{ backgroundColor: '#F9FAFB', minHeight: '250px' }}>
      {/* Imagen circular */}
      ...
      {/* Título */}
      <p className="text-[16px] text-[#0B4653] mb-3">
        {expert.title}
      </p>
