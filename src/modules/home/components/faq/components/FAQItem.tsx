    ...
    <div className="border-b border-cem-neutral-gray-200 last:border-b-0">
      ...
      >
        <div className="flex items-center gap-4 flex-1">
          <span
            className={`text-xl md:text-2xl font-medium flex-shrink-0 transition-colors duration-300 ${
          ...
          <h3
            className={`text-base md:text-lg font-semibold flex-1 transition-colors duration-300 ${
