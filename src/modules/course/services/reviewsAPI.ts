...
export const createRating = async (
  ...
  try {
    const response = await apiConnector("POST", ratingsEndpoints.CREATE_RATING_API, data, {
...
export const updateRating = async (
  ...
  try {
    const response = await apiConnector("PATCH", ratingsEndpoints.UPDATE_RATING_API, data, {
      Authorization: `Bearer ${token}`,
    });
