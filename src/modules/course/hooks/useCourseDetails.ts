  ...
  useEffect(() => {
    const fetchCourseDetailsData = async () => {
      try {
        ...
        const normalizedCourseId = Array.isArray(courseId) ? courseId[0] : courseId || "mock_id"
              ...
              courseContent: [
                {
                  ...
                  subSection: [
                    { _id: "sub1", title: "Welcome to the Course", timeDuration: "5:00", description: "Intro", videoUrl: "" },
                    { _id: "sub2", title: "How the Web Works", timeDuration: "10:30", description: "Basics", videoUrl: "" }
                  ]
                },
                {
                  _id: "sec2",
                  ...
                  subSection: [
                    { _id: "sub3", title: "JSX and Components", timeDuration: "15:00", description: "React Basics", videoUrl: "" },
                    { _id: "sub4", title: "State and Props", timeDuration: "20:00", description: "Data flow", videoUrl: "" }
                  ]
                }
              ],
              ratingAndReviews: [
                { _id: "rev1", user: { _id: "user1", firstName: "John", lastName: "Doe", email: "john@example.com" }, rating: 5, review: "Great course!", course: normalizedCourseId },
                { _id: "rev2", user: { _id: "user2", firstName: "Jane", lastName: "Smith", email: "jane@example.com" }, rating: 4, review: "Very helpful", course: normalizedCourseId },
                { _id: "rev3", user: { _id: "user3", firstName: "Bob", lastName: "Johnson", email: "bob@example.com" }, rating: 5, review: "Excellent!", course: normalizedCourseId }
              ],
              instructor: {
                _id: "instructor1",
                firstName: "John",
