    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-4 sm:gap-6">
      {cards.map((card, index) => {
        ...
        return (
          <div
            key={index}
            className="bg-white rounded-xl border border-cem-neutral-gray-100 p-6 hover:border-cem-primary/30 transition-all duration-200 shadow-sm min-h-[180px] flex flex-col justify-between"
          >
