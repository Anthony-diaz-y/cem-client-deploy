...
export const RevenueCardSkeleton = () => {
    return (
        <div className="bg-gradient-to-br from-cem-primary to-[#036d85] rounded-2xl px-8 py-4 animate-pulse shadow-sm h-full w-full flex flex-col justify-between relative overflow-hidden min-h-[95px]">
